    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Column 1 */}
          <div>
            <h3 className="text-xl font-bold mb-4">Mayank Kumar Gupta</h3>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-2">mg258087@gmail.com</p>
            <p className="text-gray-400 mb-4">+91 8393018077</p>
            <a 
              href="/resume.pdf" 
              download
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            &copy; {currentYear} Mayank Kumar Gupta. All rights reserved.
          </p>
